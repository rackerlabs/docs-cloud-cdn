...
# html_title = 'Rackspace CDN v1.0 API Guide'
...
htmlhelp_basename = 'docs-rackspace-cdndoc'
...
latex_documents = [
  (master_doc, 'docs-cloud-cdn.tex',
   'Rackspace CDN API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace CDN API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-cdn', 'Rackspace CDN API documentation',
   'Rackspace', 'docs-cloud-cdn', 'Learn about using the Product',
   'Miscellaneous'),
]
