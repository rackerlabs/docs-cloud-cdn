...
- [issue 42] Use case H1 topics use imperative, H2 topics use gerund
...
- [issue 43]  Prerequisites include config environment variables (late change)
...
- [issue 44]  Uses common Get Credentials topic ==> Save your API Key, Save your Account number are heading levels.
...
- [issue 44]  Send API requests content follows template (some docs have only cURL, some have cURL and CLI)
...
- [issue 45]  Review auth response section has link to annotated auth response.
...
- [issue 46] Service access endpoints topic follows authentication

- [issue 47] Service access endpoints topic has link to auth response in Review Auth response section.
...
- [issue 48] Make sure spacing is OK -- as good as it can be.
