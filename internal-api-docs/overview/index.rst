...
Interactions with Rackspace CDN occur programmatically via the Rackspace CDN API
as described in this internal *Rackspace CDN Administration Guide*
and in the following external guides that are available on :rax-devdocs:`Rackspace API Documentation<>`:

-  *Rackspace CDN Getting Started Guide*

-  *Rackspace CDN Developer Guide*

-  *Rackspace CDN API Reference*

-  *Rackspace CDN Release Notes*
