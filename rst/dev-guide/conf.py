...
html_title = 'Rackspace CDN Version 1.0 API Developer Guide'
...
htmlhelp_basename = 'RackspaceCDNApiDeveloperDoc'
...
latex_documents = [
  ('index', 'RackspaceCDNApiDeveloperDoc.tex', 'Rackspace CDN API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCDNApiDeveloperDoc', 'Rackspace CDN API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCDNApiDeveloperDoc', 'Rackspace CDN API Developer Guide',
   'Rackspace', 'RackspaceCDNApiDeveloperDoc', 'Learn about using the REST API for the Rackspace CDN service.',
   'Miscellaneous'),
]
