...
`Request <patch-update-a-service-v1.0-project-id-services-service-id.html#request>`__
`Response <patch-update-a-service-v1.0-project-id-services-service-id.html#response>`__
