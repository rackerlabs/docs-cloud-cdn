...
`Request <delete-delete-a-service-v1.0-project-id-services-service-id.html#request>`__
`Response <delete-delete-a-service-v1.0-project-id-services-service-id.html#response>`__
